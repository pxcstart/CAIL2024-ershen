...
file_path = '/home/peter/Challenge/dataset/clean_cases.json'
with open(file_path, 'r', encoding='utf-8') as file:
    cases = json.load(file)

file_path = '/home/peter/Challenge/baseline/data/bm25_retrieve_results.json'
with open(file_path, 'r', encoding='utf-8') as file:
...
with open('/home/peter/Challenge/baseline/data/reason_prediction.json', 'w', encoding='utf-8') as f:
